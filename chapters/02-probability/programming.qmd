## Programming Session {#sec-02-programming}
...
load("data/JPRdata_Haim.rda")
COW_country_codes <- read_csv("data/COW-country-codes.csv")
...
```{r}
#| echo: false
#| fig-cap: "Haim's Research Question"

knitr::include_graphics("images/haim.png")
```
...
library(readr)
#create a subfolder called "data" first
JPRdata_select <- readr::read_csv(
  "data/JPRdata_select.csv" 
)
head(JPRdata_select)
