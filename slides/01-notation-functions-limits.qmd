---
title: '<span style="color:#000;">Talking in</span> <span class="flatly-green" style="font-style:italic;">Mathematics</span>'
...
-   **Hypothesis:** a testable statement, derived from a theory, about the expected relationship between concepts or variables.
-   [**Let's hear some ideas from your research areas!**]{.flatly-green}
:::

## Today's Agenda {.smaller}

::: {.incremental}
-   **Sets** — reading a dataset as a set, unions and intersections.
-   **Essential Math Refresher** — levels of measurement, arithmetic, order of operations, sequences and series.
-   **Notations** — summation, product, factorial, and modulo notation.
-   **Functions** — mappings, domain/range/codomain, composition, dimensionality.
...
![](01-notation-functions-limits/images/vdem-polyarchy-gdppc-2019.png){width="60%" fig-align="center" .nostretch}
...
.viz-scatter-to-sets.sts-revealed .sts-dot-hl {
  r: 6;
  filter: drop-shadow(0 0 4px var(--hlc, #18BC9C));
}
</style>
...
<svg class="viz-plot" viewBox="0 0 300 220" role="img" aria-label="Circle A entirely inside circle B">
  ...
  <circle cx="150" cy="115" r="46" fill="#18BC9C"/>
...
<svg class="viz-plot" viewBox="0 0 320 200" role="img" aria-label="Two overlapping circles A and B with their intersection highlighted">
  <circle cx="130" cy="100" r="80" fill="#18BC9C" fill-opacity="0.6"/>
...
<svg class="viz-plot" viewBox="0 0 320 220" role="img" aria-label="Two overlapping circles A and B, both fully shaded to represent their union">
  <circle cx="130" cy="110" r="80" fill="#18BC9C"/>
  <circle cx="210" cy="110" r="80" fill="#18BC9C"/>
  <text x="80" y="35" font-size="20" fill="#22303F">A</text>
  <text x="250" y="35" font-size="20" fill="#22303F">B</text>
...
<svg class="viz-plot" viewBox="0 0 340 200" role="img" aria-label="Two separate, non-overlapping circles A and B">
  <circle cx="90" cy="100" r="70" fill="#18BC9C"/>
...
## Levels of Measurement (1/2) {.smaller}
...
## Levels of Measurement (2/2) {.smaller}
...
## Basic Properties of Arithmetic (1/2) {.smaller}
...
## Basic Properties of Arithmetic (2/2) {.smaller}
...
<div class="viz function-check-map">
  <div class="fcm-panel">
    <svg class="viz-plot" viewBox="0 0 240 200" role="img" aria-label="A valid function: each of three inputs points to exactly one output, though two inputs share the same output">
      ...
      <circle cx="180" cy="80" r="4" fill="#18BC9C"/><text x="192" y="75" font-size="12" fill="#18BC9C">y&#8321;</text>
      <circle cx="180" cy="140" r="4" fill="#18BC9C"/><text x="192" y="145" font-size="12" fill="#18BC9C">y&#8322;</text>
  ...
  <div class="fcm-panel">
    <svg class="viz-plot" viewBox="0 0 240 200" role="img" aria-label="Not a function: one input points to two different outputs">
      <text x="120" y="20" text-anchor="middle" font-size="14" font-weight="700" fill="#BC1838">Not a function</text>
      <circle cx="60" cy="60" r="4" fill="#22303F"/><text x="40" y="55" font-size="12" fill="#22303F">x&#8321;</text>
      <circle cx="60" cy="100" r="4" fill="#22303F"/><text x="40" y="105" font-size="12" fill="#22303F">x&#8322;</text>
      <circle cx="60" cy="140" r="4" fill="#22303F"/><text x="40" y="145" font-size="12" fill="#22303F">x&#8323;</text>
      <circle cx="180" cy="70" r="4" fill="#BC1838"/><text x="192" y="65" font-size="12" fill="#BC1838">y&#8321;</text>
      <circle cx="180" cy="110" r="4" fill="#BC1838"/><text x="192" y="115" font-size="12" fill="#BC1838">y&#8322;</text>
      <circle cx="180" cy="150" r="4" fill="#18BC9C"/><text x="192" y="155" font-size="12" fill="#18BC9C">y&#8323;</text>
      <line x1="64" y1="60" x2="176" y2="70" stroke="#BC1838" stroke-width="1.5" marker-end="url(#fcm-arrow-bad)"/>
      <line x1="64" y1="60" x2="176" y2="110" stroke="#BC1838" stroke-width="1.5" marker-end="url(#fcm-arrow-bad)"/>
      <line x1="64" y1="140" x2="176" y2="150" stroke="#5A6B80" stroke-width="1.5" marker-end="url(#fcm-arrow-bad2)"/>
      <defs>
        <marker id="fcm-arrow-bad" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#BC1838"/></marker>
...
<svg class="viz-plot" viewBox="0 0 500 280" role="img" aria-label="A function f mapping four points in the domain A to points in the codomain B; the range is the subset of the codomain that is actually hit, smaller than the full codomain">
  ...
  <ellipse cx="362" cy="143" rx="55" ry="72" fill="#18BC9C" fill-opacity="0.18" stroke="#18BC9C" stroke-width="2" stroke-dasharray="5,4"/>
  <text x="362" y="235" text-anchor="middle" font-size="14" font-weight="700" fill="#18BC9C">Range</text>
  ...
  <circle cx="340" cy="90" r="5" fill="#18BC9C"/>
  <text x="316" y="78" font-size="13" fill="#18BC9C">y₁</text>
  <circle cx="340" cy="150" r="5" fill="#18BC9C"/>
  <text x="316" y="168" font-size="13" fill="#18BC9C">y₃</text>
  <circle cx="400" cy="190" r="5" fill="#18BC9C"/>
  <text x="406" y="210" font-size="13" fill="#18BC9C">y₄</text>
...
<div class="viz function-check-map">
  <div class="fcm-panel">
    <svg class="viz-plot" viewBox="0 0 240 200" role="img" aria-label="One-to-one: three inputs each map to their own distinct output">
      ...
      <circle cx="60" cy="100" r="4" fill="#22303F"/><text x="40" y="105" font-size="12" fill="#22303F">x&#8322;</text>
      <circle cx="60" cy="140" r="4" fill="#22303F"/><text x="40" y="145" font-size="12" fill="#22303F">x&#8323;</text>
      <circle cx="180" cy="60" r="4" fill="#18BC9C"/><text x="192" y="55" font-size="12" fill="#18BC9C">y&#8321;</text>
      <circle cx="180" cy="100" r="4" fill="#18BC9C"/><text x="192" y="105" font-size="12" fill="#18BC9C">y&#8322;</text>
      <circle cx="180" cy="140" r="4" fill="#18BC9C"/><text x="192" y="145" font-size="12" fill="#18BC9C">y&#8323;</text>
...
<div class="viz dim-sets">
  <div class="dim-panel">
    <svg class="viz-plot" viewBox="0 0 200 160" role="img" aria-label="R1: a single number line with one point marked, an example of a 1-tuple">
      ...
      <circle cx="145" cy="90" r="5" fill="#18BC9C"/>
      <text x="145" y="72" text-anchor="middle" font-size="13" fill="#18BC9C">(3)</text>
      <defs>
  ...
  <div class="dim-panel">
    <svg class="viz-plot" viewBox="0 0 200 160" role="img" aria-label="R2: a coordinate plane with x and y axes crossing at the origin, and one point marked with dashed guide lines to each axis">
      ...
      <circle cx="55" cy="50" r="5" fill="#18BC9C"/>
      <text x="30" y="42" font-size="13" fill="#18BC9C">(-15, 5)</text>
      <defs>
  ...
  <div class="dim-panel">
    <svg class="viz-plot" viewBox="0 0 200 200" role="img" aria-label="R3: three axes x, y, and z meeting at the origin, with one point in space located by dashed guide lines showing its x, y, and z coordinates">
      ...
      <circle cx="121" cy="95" r="5" fill="#18BC9C"/>
      <text x="128" y="88" font-size="13" fill="#18BC9C">(x, y, z)</text>
      <defs>
...
## Quick Reference: Symbols and Notation (1/2) {.smaller}

:::: {style="font-size: 0.5em; color: #5A6B80; margin-bottom: 0.3em;"}
Table 1.2, Moore & Siegel (2013), *A Mathematics Course for Political and Social Research*, ch. 1.
::::
...
<table>
<thead><tr class="fragment fade-in" data-fragment-index="1"><th>Symbol</th><th class="meaning-head fragment fade-in" data-fragment-index="3">Meaning</th></tr></thead>
<tbody>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">+</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Addition</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">−</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Subtraction</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">∗, ×, ·</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Multiplication</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">/, ÷</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Division</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1">±</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Plus or minus</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">xⁿ</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Exponentiation (“to the nth power”)</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">ⁿ√x</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Radical or nth root</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">!</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Factorial</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">∞</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Infinity</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">Σ</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Sum of xᵢ from i = k to i = l</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">Π</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Product of xᵢ from i = k to i = l</td></tr>
</tbody>
</table>
</div>
<div class="notation-col">
...
<thead><tr class="fragment fade-in" data-fragment-index="1"><th>Symbol</th><th class="meaning-head fragment fade-in" data-fragment-index="3">Meaning</th></tr></thead>
<tbody>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">…</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Continued progression</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1">d⁄dx</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Total derivative with respect to x</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1">∂⁄∂x</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Partial derivative with respect to x</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1">∫dx</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Integral over x</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">∪</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Set union</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">∩</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Set intersection</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">×</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Cartesian product of sets</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1">∖</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Set difference</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1">Aᶜ</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Complement of set A</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">∅</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Empty (or null) set</td></tr>
</tbody>
</table>
</div>
</div>
...
## Quick Reference: Symbols and Notation (2/2) {.smaller}
...
<thead><tr class="fragment fade-in" data-fragment-index="1"><th>Symbol</th><th class="meaning-head fragment fade-in" data-fragment-index="3">Meaning</th></tr></thead>
<tbody>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">∈</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Set membership</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1">∉</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Not member of set</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">∣, :, ∋</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Such that</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">⊂</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Proper subset</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">⊆</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Subset</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">&lt;</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Less than</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">≤</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Less than or equal to</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">=</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Equal to</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">&gt;</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Greater than</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">≥</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Greater than or equal to</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1">≠</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Not equal to</td></tr>
</tbody>
</table>
</div>
<div class="notation-col">
...
<thead><tr class="fragment fade-in" data-fragment-index="1"><th>Symbol</th><th class="meaning-head fragment fade-in" data-fragment-index="3">Meaning</th></tr></thead>
<tbody>
<tr><td class="fragment fade-in" data-fragment-index="1">≡</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Equivalent to or defined as</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">f(), f(·)</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Function</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">{ }</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Delimiter for discrete set</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">( )</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Delimiter for open set</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1"><span class="fragment highlight-green" data-fragment-index="2">[ ]</span></td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Delimiter for closed set</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1">∀</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">For all (or for every/each)</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1">∃</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">There exists</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1">⇒</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Implies</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1">⇔</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">If and only if</td></tr>
<tr><td class="fragment fade-in" data-fragment-index="1">¬C, ∼C</td><td class="meaning-cell fragment fade-in" data-fragment-index="3">Negation (not C)</td></tr>
</tbody>
</table>
</div>
</div>
...
## Watch It Happen — Residuals & Minimizing $S(c)$ {.smaller}
...
```{=html}
<div class="viz join-minimize jm-part-residuals jm-part-curve">
  <div class="jm-columns">
    <div class="jm-col">
  ...
  <div class="jm-hint">Drag the green point on the number line, or use the slider — both graphs move together.</div>
</div>

<style>
.viz.join-minimize { max-width: 900px; margin: 0 auto; font-size: 0.5em; }
.join-minimize .jm-columns { display: flex; gap: 24px; align-items: flex-start; }
.join-minimize .jm-col { flex: 1 1 50%; min-width: 0; }
...
.join-minimize .jm-marker-line { stroke: #18BC9C; stroke-width: 2; }
.join-minimize .jm-marker { fill: #18BC9C; cursor: grab; touch-action: none; }
.join-minimize .jm-marker:active { cursor: grabbing; }
.join-minimize .jm-bar-pos { stroke: #18BC9C; stroke-width: 5; }
.join-minimize .jm-bar-neg { stroke: #BC1838; stroke-width: 5; }
...
.join-minimize .jm-slider { flex: 1 1 auto; max-width: 360px; accent-color: #18BC9C; }
.join-minimize .jm-snap {
  font-size: 0.9em; padding: 5px 12px; border-radius: 999px; border: 1px solid #18BC9C;
  background: #fff; color: #18BC9C; cursor: pointer;
}
.join-minimize .jm-snap:hover { background: #18BC9C; color: #fff; }
...
.join-minimize.jm-at-min .jm-readout-item { background: #FBE9ED; border-color: #BC1838; }
.join-minimize.jm-at-min .jm-readout-value { color: #BC1838; }

.join-minimize .jm-curve-line { fill: none; stroke: #18BC9C; stroke-width: 2.5; }
.join-minimize .jm-curve-dot { fill: #18BC9C; stroke: #fff; stroke-width: 1.5; }
