...
### Day 3 — Uncertainty Extended and Expected / Exploration

**Math:** combinatorics; random variables; expectation algebra;
...
**Math:** integration and area under the curve; limits; differentiation
— learning to read $\int$, $\lim$, and $\dfrac{dy}{dx}$ before computing
them, with each tool tied back to Day 3's PDFs, CDFs, and expectation.
...
[Slides](chapters/04-calculus/slides.qmd) &nbsp;|&nbsp;
[Programming Lecture](chapters/04-calculus/programming.qmd)
