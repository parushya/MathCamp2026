...
### Day 3 — Uncertainty Extended and Expected / Calculus / Exploration

Day 3 runs two math sessions.
**Math (Session 1 — Uncertainty Extended and Expected):** combinatorics;
random variables; expectation algebra; conditional expectation and the
type-shift ($E[Y|X=x]$ vs. $E[Y|X]$).
**Math (Session 2 — Calculus):** limits; differentiation and
optimization (first-order conditions); integration basics; area under
the curve.
